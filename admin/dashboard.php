                ...
                <div class="container-fluid">
                    <?php if(empty($posts)): ?>
                        <div class="alert alert-info">
                            <i class="icon fas fa-info"></i> You haven't created any posts yet.
                        </div>
                    <?php else: ?>
                        <div class="card">
                                        ...
                                        <?php foreach($posts as $post): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="dashboard.php?delete=<?php echo $post['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this post?')">
